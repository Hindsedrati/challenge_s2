...
class Carousel extends Component {
    constructor(props) {
        super(props);
        // this.isFancy = props.isFancy;
        // this._reactInstance = this;
        this.images = [
        "../ceo.png",
        "../assets/logo.svg",
        "../ceo.png",
    ...
    render() {
        ...
        MiniReact.createElement(
            ...
            index === this.state.current
                ? MiniReact.createElement("img", { src: image })
                : null
            ),
            MiniReact.createElement(Button, {
            title: previous,
            class: "absolute left-[10px] bg-white rounded-full p-2 cursor-pointer",
            onClick: this.handlePreviousClick,
            }),
            MiniReact.createElement(Button, {
            title: next,
            class: "absolute right-[10px] bg-white rounded-full p-2 cursor-pointer",
