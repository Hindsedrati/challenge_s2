            ...
            MiniReact.createElement(
                ...
                MiniReact.createElement(
                    ...
                    MiniReact.createElement("div", {
                        ...
                        MiniReact.createElement("div", {
                                class: `absolute right-0 h-0  w-[250px] h-auto bg-red-500 shadow-md z-10 rounded-md flex flex-col bg-white divide-y divide-y-gray-100 overflow-y-auto transition-all duration-300 ease-in-out ${this.state.openedNotification ? 'top-10' : '-top-[1500px]'} `,
