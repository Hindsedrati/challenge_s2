...
const EventDetails = () => {
  const id = MiniReact.getUrlParameters().id;
  ...
  return event
    ? MiniReact.createElement(
        ...
        MiniReact.createElement(
          ...
          MiniReact.createElement(Image, {
            ...
            alt: event?.title,
            class:
              "h-48 w-full object-cover object-center rounded-lg shadow-md",
          }),
          MiniReact.createElement(
            "h1",
            {
          ...
          MiniReact.createElement(
            ...
            MiniReact.createElement(
              ...
              MiniReact.createElement(
                ...
                {
                  class:
                    "ml-auto bg-yellow-500 block flex items-center font-bold rounded-3xl px-4",
                },
                event?.time
              )
            ),
          ...
          MiniReact.createElement(
            ...
            {
              class:
                "flex items-center justify-around space-x-8 mt-8 flex-wrap",
            },
            MiniReact.createElement(
              "div",
              {},
    ...
    : MiniReact.createElement(ErrorPage);
};
